...
export const authService = {
    ...
    async getUserProfile(userId: string) {
        ...
        const guestProfile = {
            ...
            email: 'oficina13central@gmail.com',
            role: 'superusuario',
            roles: {
                id: 'superusuario',
    ...
    async enrichProfile(profile: any) {
        // Forzar permisos de superusuario siempre para estos usuarios específicos
        const superUsers = ['oficina13central@gmail.com', 'isaacgomez78@gmail.com'];
        if (superUsers.includes(profile.email)) {
